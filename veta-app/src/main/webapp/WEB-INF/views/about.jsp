...
<div class="wrap" style="padding:52px 0">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center;margin-bottom:52px">
    <div>
      ...
      <p style="color:var(--g700);margin-bottom:13px;font-size:.93rem"><% if(sw){ %>Chuo cha VETA kilianzishwa mwaka 2005 chini ya Sheria ya Mamlaka ya Elimu na Mafunzo ya Ufundi kutoa mafunzo ya ufundi yenye ubora, yanayofaa na yanayopatikana kwa vijana wa Tanzania. Kwa zaidi ya Miaka 20, tumekuwa taasisi inayotambuliwa kitaifa ikitoa programu zilizoidhinishwa na NVA.<% } else { %>KIGOMA RVTSC was established in 2005 under the Vocational Education and Training Authority Act to provide quality, relevant and accessible vocational training to Tanzanian youth. Over 20 years, we have grown into a nationally recognized institution offering NVA-certified programs.<% } %></p>
