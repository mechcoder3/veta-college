...
<body>
	...
	<div class="fixed-header-container">
		...
		<div id="topbar">
			<div class="wrap">
				<div class="tb-left">
					<span>📞 +255282804951</span> <span class="sep">|</span> <span>✉️
						kigomarvtsc@veta.go.tz</span> <span class="sep">|</span> <span>📍
						Kigoma-Tanzania</span>
				</div>
				<div class="tb-right">
					<%
 ...
 %>
				...
				<button class="menu-toggle"
					onclick="document.getElementById('mobileNav').classList.toggle('open')">☰</button>
			</div>
		</div>
